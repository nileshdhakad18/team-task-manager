    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="w-full max-w-md space-y-8 rounded-2xl bg-surface p-8 shadow-xl border border-gray-800">
        <div className="flex flex-col items-center">
          ...
          <p className="mt-2 text-sm text-gray-400">Join Team Task Manager</p>
        </div>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          <div className="space-y-4">
            ...
            <div>
              ...
              <select
                className="mt-1 block w-full rounded-lg border border-gray-700 bg-background px-4 py-2.5 text-white focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-colors"
                value={role}
              ...
              <p className="mt-1 text-xs text-gray-500">Note: Admin role is exposed for testing purposes.</p>
            </div>
          </div>
